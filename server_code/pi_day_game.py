...
class PiDayGame:
	...
	game_outro = "=*"*40
	game_outro += "\nThanks for playing! Your answers (if any) have been saved.\nIf you haven't finished the game, resume any time with 'start'.\nIf you have, check out the leaderboard with 'leaderboard' event command!\n"
	game_outro += "=*"*40
